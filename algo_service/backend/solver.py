...
def build_segments(
    ...
    for obs in obstacles:
        ...
        instructions, end_sx, end_sy, end_heading = result
        ...
        # Next segment starts from capture position; robot is facing the obstacle (face)
        sx, sy, heading = end_sx, end_sy, end_heading
